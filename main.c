...
const char *group_list[ ] = { "usa", "iwm", "ibd", "biotech", "3x", "china", "canada", NULL };

static void print_usage(void)
{
	printf("Usage: anna -group={usa|china|canada|iwm|biotech|ibd|3x} [-date=yyyy-mm-dd] [-conf=filename]\n");
